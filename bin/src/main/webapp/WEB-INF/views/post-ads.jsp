...
$(function() {
	...
	// 	var picture = $('#post-image').get(0).files;
	// 	var data_form = new FormData();
	// 	data_form.append("img",picture[0]);
	// 	data_form.append("image_name","mypic");
		
	// 	console.log(new FormData($("#post-image")[0]))	
