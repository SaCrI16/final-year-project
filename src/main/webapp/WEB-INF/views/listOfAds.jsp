...
function templateAds(ads){
	...
	$(".main").append(_col);
  			//$('.card-img-top').attr('src', 'data:image/png;base64',val)
			 // console.log(ads.imageContents[0]);
			  
 			//document.getElementById("ItemPreview").src = "data:image/png;" + ads.imageContents[0];
			
			
 	  
	var _image = $("<div class=\"col-md-2\" style=\"padding: 0 0px 0 22px;\"><img class=\"card-img-top\" id=\"ItemPreview\" src=\"data:image/png;base64,"+ ads.imageContents[0] +"\" alt=\"Card image cap\"></div>");
	 _col.before(_image);		
	...
	var _city = $("<h6 class=\"card-subtitle mb-2 text-muted\">"+ads.address.city+"</h6>");
	 _title.after( _city);
