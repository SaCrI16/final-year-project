		...
		<div class="row justify-content-md-center mt-5">
			...
			<div class="col-sm-6 col-md-8 mb-4">
                ...
                <div class="col-md-12 mb-3 mt-5 mb-5" style="padding-left: 0; padding-right: 0;">
                    <form id="uploadForm" action="/advertisement/${param.info}/addd-image" method="post" enctype="multipart/form-data">
					...
					<button type="submit" class="btn btn-submit mb-5 mt-5" type="button">Upload Photo</button>
                   </form> 
                </div>
...
function Preview(objFileInput) {
    if (objFileInput.files[0]) {
        ...
        fileReader.onload = function (e) {
            $("#img-section").html('<img src="'+e.target.result+'" width="200px" height="200px" class="upload-preview" style="margin-top: 100px;" />');
			$("#img-section").css('opacity','1');
			$(".icon-choose-image").css({'opacity':'0.5','margin-top':'100px;'});
        }
